 ...
 * edited to work with current frc (crescendo 2024)
 * switched from buttons to triggers, added super + booleansupplier
 * to allow everything to work together
 * not very elegant of a method, still works
 */ 
public class JoystickAnalogButton extends Trigger {
   ...
   */
  public JoystickAnalogButton(GenericHID joystick, int axisNumber, BooleanSupplier bs) {
   ...
   */
  public JoystickAnalogButton(GenericHID joystick, int axisNumber, double threshold, BooleanSupplier bs) {
